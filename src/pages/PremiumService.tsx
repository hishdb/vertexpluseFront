import premiumBackground from '../assets/proMale.png';
import manWithSuitBackground from '../assets/manWitthSwuiteBackground.png';
import Background from '../assets/rectanglesBackground.png';
