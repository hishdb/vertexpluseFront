...
import backgroundglobal from "../assets/CoverIndicesBackground.png";
...
function Indices() {
    ...
    const faqData = [
      {
        question: t("IndicesFaq.q1"),
        answer: t("IndicesFaq.a1"),
      },
      {
        question: t("IndicesFaq.q2"),
        answer: t("IndicesFaq.a2"),
      },
      {
        question: t("IndicesFaq.q3"),
        answer: t("IndicesFaq.a3"),
      },
      {
        question: t("IndicesFaq.q4"),
        answer: t("IndicesFaq.a4"),
      },
    ];
    ...
    <main className="flex-grow ">
      ...
      <CoverAnimationWithoutImage backgroundImage={backgroundglobal}   text1={t("TradeIndexCFDs")} text2={t("")} text3={t("TradeTheMostPopularIndicesAround")}/>  
      <PaymentMethodsSection/>
    <GlobalMarketsSectionWithParameters text1={t("TradeIndicesWithLeverage")} text2={t("MagnifyTheSizeOfYourTradesWithoutCommittingLargeAmountsOfCapital")} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-semibold mb-4">
                {t("FREERealTimeIndexQuotes")}
              </h3>
              <p className="text-gray-600 text-sm md:text-base mb-6 leading-relaxed">
                {t("GetFreeRealTimeStreamingQuotesOnAllIndices")}
              </p>
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-semibold mb-4">
                {t("QuickAndEasyAccountFunding")}
              </h3>
              <p className="text-gray-600 text-sm md:text-base mb-6 leading-relaxed">
                {t("ApplyingForAccountTakesOnlyFewMinutes")}
              </p>
            </div>
          </div>
        </div>
      ...
      <WhyVertexPluse/>  
      <TwoTexts text1={t("WhatIsIndicesTrading")} text2={t("TradingIndicesCFDInvolvesTheBuyingOrSellingOfIndex")}/>
      
      <HowDoITrade
      title={t("HowDoITradeCommodities")}
      subtitle={t("StartTradingCommodities5SimpleSteps")}
      steps={[
