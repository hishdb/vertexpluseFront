    ...
    <div className="relative bg-trasnparent min-h-screen w-full overflow-hidden mt-60">
      ...
      <div className="text-white w-full md:w-1/2 space-y-14 p-8 mt-32 md:mt-0">
          ...
          <ul className="space-y-6 pb-20">
                ...
                />
                <p className="text-white font-normal text-md sm:text-2xl">
      ...
      <div className="flex mb-8 mt-10 relative">
        <motion.div
          className="relative -right-0 transform shadow-2xl rounded-full sm:-right-40 md:-right-50 lg:-right-50"
        ...
        <motion.div
          className="absolute w-full -right-0 sm:-right-60 md:-right-80 lg:-right-80 md:w-auto shadow-2xl rounded-full"
          initial={{ opacity: 0, x: -50 }}
          whileInView={{ opacity: 1, x: 0.3, rotate: ['0deg', '20deg'] }}
          viewport={{ once: true }}
          transition={{ duration: 1.8 }}
        >
